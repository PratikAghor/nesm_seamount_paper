...
%
%  modified by sdxmonkey on Feb-20-2020
%
%  Further Information:  
...
% Common parameters
%
dir_path = '/storage/home/hcoda1/9/paghor3/scratch/work/SEAMOUNT_2019_2020/'
DATADIR = [dir_path, 'data/'];
Roa = 10e3;
makeplot = 0;
% coastfileplot = 'coastline_l.mat';
% coastfilemask = 'coastline_l_mask.mat';
t_min = datenum('2019-01-01');
...
nc_add_tides(frcout,Ntides,date_mjd,components)
ncfrc=netcdf(frcout,'write');
% 
%----------------------------------------------------------
...
%    figure
%    plot_tide(grdname,frcout,itide,0.5,2,coastfileplot)
  end
 
  figure
  clm_tides(grdname,frcout,Ntides,Ymin,Mmin,Dmin,...
