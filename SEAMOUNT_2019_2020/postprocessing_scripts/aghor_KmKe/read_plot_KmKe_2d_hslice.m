...
if(strcmp(case_type, 'instant'))
    nt=3040;
    KmKe_2d_file = strcat('seamount_2019_2020_instant_KmKe_2d_hslice_nt_', string(nt), ...
...
elseif(strcmp(case_type, 'avg'))
    ...
    KmKe_2d_file = strcat('seamount_2019_2020_KmKe_2d_hslice_nt_', string(KmKe_2d_indxRange(1)), '_', string(KmKe_2d_indxRange(mean_Nt)), ...
        '_vlevel_', string(vlevel), '.nc');
end
...
% if(strcmp(case_type, 'instant'))
%     figname  = [plots_path, 'rs_plots/hrs/seamount_2019_2020_instant_hrs_2d_hslice'];
% 
%     figname = strcat(figname, '_vlevel_', string(vlevel));
%     figname = strcat(figname, '_nt_', string(nt), ...
%         '_vlevel_', string(vlevel));
% elseif(strcmp(case_type, 'avg'))
%     figname  = [plots_path, 'rs_plots/hrs/seamount_2019_2020_hrs_2d_hslice'];
% 
%     figname = strcat(figname, '_vlevel_', string(vlevel));
...
% set(figure1, 'Visible', 'off'); % stop pop-ups
% if(strcmp(case_type, 'instant'))
%     figname  = [plots_path, 'rs_plots/vrs/seamount_2019_2020_instant_vrs_2d_hslice'];
% 
%     figname = strcat(figname, '_vlevel_', string(vlevel));
%     figname = strcat(figname, '_nt_', string(nt), ...
%         '_vlevel_', string(vlevel));
% elseif(strcmp(case_type, 'avg'))
%     figname  = [plots_path, 'rs_plots/vrs/seamount_2019_2020_vrs_2d_hslice'];
% 
%     figname = strcat(figname, '_vlevel_', string(vlevel));
%     figname = strcat(figname, '_nt_', string(indxRange(1)), '_', string(indxRange(Nt)), ...
%         '_vlevel_', string(vlevel));
...
% %%%
% set(figure1, 'Visible', 'off'); % stop pop-ups
% figname  = [plots_path, 'rs_plots/KmKe/seamount_2019_2020_KmKe_2d_hslice'];
% 
% figname = strcat(figname, '_vlevel_', string(vlevel));
% figname = strcat(figname, '_nt_', string(indxRange(1)), '_', string(indxRange(Nt)), ...
%     '_vlevel_', string(vlevel));
...
set(figure1, 'Visible', 'off'); % stop pop-ups
if(strcmp(case_type, 'instant'))
    figname  = [plots_path, 'rs_plots/KmKe/seamount_2019_2020_instant_KmKe_2d_hslice_boxes'];
...
elseif(strcmp(case_type, 'avg'))
    figname  = [plots_path, 'rs_plots/KmKe/seamount_2019_2020_KmKe_2d_hslice_boxes'];
