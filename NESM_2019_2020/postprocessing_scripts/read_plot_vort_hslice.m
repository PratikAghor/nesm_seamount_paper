...
tskip = 1;
vlevel_skip = 50;
vort_t_filename = strcat('nesm_2019_2020_vort_t_hslice_vlevel_', string(vlevel(1)), '_nt_',string(indxRange(1)), '_', ...
    string(indxRange(Nt)), '.nc');
u_t_filename = strcat('nesm_2019_2020_u_t_hslice_vlevel_-100_nt_',string(uv_indxRange(1)), '_', ...
    string(uv_indxRange(uv_Nt)),'.nc');

v_t_filename = strcat('nesm_2019_2020_v_t_hslice_vlevel_-100_nt_',string(uv_indxRange(1)), '_', ...
    string(uv_indxRange(uv_Nt)),'.nc');
...
for nt = 3099:tskip:3102
    ...
    %%%
        ...
        figname  = [plots_path, 'vort_plots/hslice/nesm_2019_vort'];
