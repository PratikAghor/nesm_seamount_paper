...
#############################
vlevel = -4500
filename1="nesm_2019_2020_speed_t_hslice_vlevel_" + str(vlevel) + "_nt_0_3382.nc"
# filename2="nesm_2019_speed_t_hslice_vlevel_0_nt_1000_1999.nc"
# filename3="nesm_2019_speed_t_hslice_vlevel_0_nt_2000_2902.nc"
...
np.savetxt("../../compare/avg_surf_velo/nesm_avg_full_surf_velo_vlevel_" \
        + str(vlevel) + ".asc", velo_avg_full[~np.isnan(velo_avg_full)])
np.savetxt("../../compare/avg_surf_velo/nesm_avg_surf_velo_vlevel_" + str(vlevel) + ".asc", velo_avg[~np.isnan(velo_avg)])
