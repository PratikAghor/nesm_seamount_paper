...
%-------------------------------------------------------
%%
pv_t_filename = strcat('nesm_2019_2020_pv_t_vslice_const_lon_nt_',string(indxRange(1)), '_', ...
...
vort_t_filename = strcat('../nesm_2019_2020_vort_t_hslice_vlevel_', string(vlevel(1)), '_nt_',string(vort_indxRange(1)), '_', ...
...
for nt = 1:Nt
    ...
    for j = 1:length(lon_arr)
        ...
        if (strcmp(sec, 'zoom')==true)
            figname  = [plots_path, 'si_check/vslice/const_lon_zoom/nesm_2019_2020_pv_t_vslice'];
        elseif(strcmp(sec, 'nozoom')==true)
            figname  = [plots_path, 'si_check/vslice/const_lon/nesm_2019_2020_pv_t_vslice'];
        end
        % 
