...
%---------------------------------------------------
%---------------------------------------------------
vebf_file = strcat('../aghor_vebf/nesm_2019_2020_VEBF_3d_nt_',string(indxRange(1)), '_', string(indxRange(Nt)),'.nc');
...
hbbl_filename =  strcat('nesm_2019_2020_hbbl_t_nt_',string(hbbl_indxRange(1)), '_', string(hbbl_indxRange(hbbl_Nt)),'.nc');
hbbl_t = ncread(hbbl_filename, 'hbbl_t');
%---------------------------------------------------
Ec_indxRange = 469:3382;
% Ec_indxRange=3016:3072;
[~, Ec_Nt] = size(Ec_indxRange);
Ec_file = strcat('nesm_2019_2020_Ec_2d_nt_',string(Ec_indxRange(1)), '_', string(Ec_indxRange(Ec_Nt)),'.nc');
...
filename = strcat('nesm_2019_2020_kv_t_vslice_const_lat_nt_',string(indxRange(1)), '_', ...
...
% save data into a netcdf file
filename = strcat('nesm_2019_2020_kv_t_vslice_const_lon_nt_',string(indxRange(1)), '_', ...
    string(indxRange(Nt)),'_laurent_ferrari.nc');
